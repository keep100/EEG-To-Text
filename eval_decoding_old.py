...
if __name__ == '__main__': 
    ...
    output_all_results_path = f'./results/{task_name}-{model_name}-all_decoding_results_{current_datetime.month}_{current_datetime.day}_{current_datetime.hour}_{current_datetime.minute}.txt'
    ''' set random seeds '''
    seed_val = 312
    ...
    # '''init wandb'''
    # run = wandb.init(project="EEG-To-Text")
